...
INSERT INTO `users` VALUES ('admin',1,'manager','Иванов Максим','1'),('alla',2,'client','Алла Илинична','2'),('roma',2,'client','Роман Александрович','2'),('sasha',1,'laborant','Иванов Максим (Лаборант)','1'),('yana',3,'client','Яна Александровна','2');
